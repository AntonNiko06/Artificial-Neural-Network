...
class Layer():
    ...
    def init_weights(self, min : float, max : float, weights_count : int, rng : np.random.Generator, method : str ="He"):
        ...
        if method=="He": # He initialization specifically for ReLU
            ...
            self.weights = rng.standard_normal((self.layer_size, weights_count)) * std_dev
